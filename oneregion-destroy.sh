...
gcloud compute health-checks delete http fgt-hcheck-tcp8008 --region=$REGION -q
gcloud compute instance-groups unmanaged delete fgt-umig-$ZONE2_LABEL --zone=$ZONE2
gcloud compute instance-groups unmanaged delete fgt-umig-$ZONE1_LABEL --zone=$ZONE1
...
gcloud compute addresses delete fgtilb-trust-ip-$REGION_LABEL --region=$REGION -q
...
gcloud compute addresses delete fgt-mgmt-eip-$ZONE2_LABEL --region=$REGION
gcloud compute addresses delete fgt-mgmt-eip-$ZONE1_LABEL --region=$REGION
gcloud compute addresses delete untrust-serv1-eip-$REGION_LABEL --region=$REGION
...
gcloud compute networks subnets delete fgt-mgmt-sb-$REGION_LABEL -q
gcloud compute networks subnets delete fgt-hasync-sb-$REGION_LABEL -q
gcloud compute networks subnets delete trust-sb-$REGION_LABEL -q
gcloud compute networks subnets delete untrust-sb-$REGION_LABEL -q
